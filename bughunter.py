...
# \______   \__ __  ____    /   |   \ __ __  _____/  |_  by AnonyminHack5
#  |    |  _/  |  \/ ___\  /    ~    \  |  \/    \   __\/ __ \_  __ \
#  |    |   \  |  / /_/  > \    Y    /  |  /   |  \  | \  ___/|  | \/
...
def menu():
  ...
  [!] Top Tools for Bug Hunting [!] | https://github.com/TermuxHackz
 -----------------------------------------------------------------------
\033[0m
   [1] - Information Gathering
   
   [update] - Update The BugHunter
   
   [2] - Mapping  
   
   [about] - About The BugHunter 
   ...
   [exit] - Exit The BugHunter   
 """)
    choice = raw_input("AnonyminHack5 bughunter~# ")
    os.system('clear')
    if choice == "update":
        updatebughunter()
    elif choice == "1":
...
def info():
    ...
    print(bughunterlogo)
    print("""
    Information Gathering | https://github.com/TermuxHackz
    ----------------------------------------------------------------
    ...
    choice1 = raw_input("AnonyminHack5 bughunter~# ")
    if choice1 == "1":
        clearScr()
        basiccmd()
    if choice1 == "2":
...
def mapping():
    ...
    print(bughunterlogo)
    print("""
    Mapping | https://github.com/TermuxHackz/
    ----------------------------------------------------------------
    ...
    """)
    print("   [99] - Return to Main Menu \n")
    choice2 = raw_input("AnonyminHack5 bughunter~# ")
    if choice2 == "1":
        clearScr()
        nmap()
    elif choice2 == "2":
...
def discovery():
    ...
    print(bughunterlogo)
    print("""
    Discovery | https://github.com/TermuxHackz/ 
    ----------------------------------------------------------------
    ...
    """)
    print("   [99] - Return to Main Menu \n")
    choice3 = raw_input("AnonyminHack5 bughunter~# ")
    os.system('clear')
    if choice3 == "1":
        acunetix()
    if choice3 == "2":
...
def exploit():
    ...
    print(bughunterlogo)
    print("""
    Exploitation | https://github.com/TermuxHackz
    -------------------------------------------------------------------------------------------
    ...
    """)
    print("   [99] - Return to Main Menu \n")
    choice4 = raw_input("AnonyminHack5 bughunter~# ")
    if choice4 == "1":
        clearScr()
        xssradar()
    if choice4 == "2":
...
def reporting():
    ...
    print(bughunterlogo)
    print("""
    PoCs & Reporting | https://github.com/TermuxHackz
    ----------------------------------------------------------------
    ...
    """)    
    print("   [99] - Return to Main Menu \n")
    choice5 = raw_input("AnonyminHack5 bughunter~# ")
    if choice5 == "tips":
     clearScr()
     bugtips()
    if choice5 == "1":
...
def sage():
    ...
    print(bughunterlogo)
    print("""
    Tools by AnonyminHack5  | https://github.com/TermuxHackz
    ----------------------------------------------------------------
    ...
    """)
    print("   [99] - Return to Main Menu \n")
    choicesage = raw_input("AnonyminHack5 bughunter~# ")
    if choicesage == "1":
        clearScr()
        hacktronian()
    if choicesage == "2":
...
def updatebughunter():
    ...
    Check Latest Version Here : https://github.com/TermuxHackz/bughunter
    """)
...
def about():
    ...
    print ("""
---------------------------------------------------------------------
    BugHunter v1.0 by AnonyminHack5 . | https://github.com/TermuxHackz   
---------------------------------------------------------------------
    Download Directory : 
    ...
    ~/bughunter/sage/ : Tools by AnonyminHack5

    Attention : View README.md File for Installation Instruction and How To Use Guide.
---------------------------------------------------------------------
    Follow Me :  https://github.com/TermuxHackz
    Github    :  https://github.com/TermuxHackz
    YouTube   :  https://youtube.com/Gamerlinks
    Twitter   :  https://twitter.com/AnonyminHack5 
    Instagram :  https://instagram.com/AnonyminHack5
    Whatsapp group: Termux Android Hackers
---------------------------------------------------------------------
...
def hacktronian():
    ...
    Read More : https://github.com/TermuxHackz/hacktronian
    """)
    choicehacktronian = raw_input(" Do You Want To Download Hacktronian? (Y/N) : ")
    if choicehacktronian in yes:
        os.system("cd ~/bughunter/sage/ && git clone https://github.com/TermuxHackz/hacktronian.git")
...
def hackdroid():
    ...
    if choicehackdroid in yes:
        os.system("git clone https://github.com/thehackingsage/HackDroid")
...
def duckydino():
    ...
    if choiceduckydino in yes:
        os.system("git clone https://github.com/thehackingsage/ducky4arduino")
...
def infog():
    os.system('clear')
    print ("""
    A Information Gathering Tool by LinuxChoice.
    """)
